	...
	for topicName in listOfTopics:
		...
		with open(filename, 'w+') as csvfile:
			...
			for subtopic, msg, t in bag.read_messages(topicName):	# for each instant in time that has data for topicName
				...
				wr = []
				if subtopic=="/vel_based_shape_controller/x_slave":
					wr = []
					wr.append(t)
					wr.append(msg.position.x)
					wr.append(msg.position.y)
				elif subtopic=="/vel_based_shape_controller/x_dot_slave":
					wr = []
					wr.append(t)
					wr.append(msg.linear.x)
					wr.append(msg.linear.y)
				else:
					wr = []
					wr.append(t)
					for i in range(len(msg.data)):
						wr.append(msg.data[i])
